...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        initComponents();
        this.setLocationRelativeTo(null); // para que la ventana del login salga centrada en la pantalla
        // para tener datos en los campos
    ...
    {
        /**
         * validar el formulario del login y redireccionar
         */
        // obtener los datos de lso campos de texto
        ...
        if (txtUser.getText().equals("") || txtPass.getText().equals(""))
        {
            ...
            txtUser.requestFocus(); // moder el cursor al usuario
        }
        else
        {
            ev = vdao.ValidarVendedor(dni, user); // llalamos a la funcion
